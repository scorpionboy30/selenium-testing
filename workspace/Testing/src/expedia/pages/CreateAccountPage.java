...
public class CreateAccountPage {
	...
	WebElement createFreeAccountText;
	WebElement faceBookButton;
	
	public CreateAccountPage(WebDriver driver) {
		this.dRiver = driver;
	}
	public WebElement createFreeAccountTextDefault(){
		createFreeAccountText = Locator.getByXPath(dRiver, ".//*[@id='page-header']/h1");
		return createFreeAccountText;
	}
	...
	public WebElement allEmptyMessage(){
		allEmpty = Locator.getByXPath(dRiver,".//*[@id='blank-create-param-id']/h5");
		return allEmpty;
	}
	
	public WebElement passwordLengthMessage(){
		passwordLength = Locator.getByXPath(dRiver, ".//*[@id='pass-length-id']/h5");
		return passwordLength;
	}
	
	public WebElement passwordMismatchMessage(){
		passwordMismatch = Locator.getByXPath(dRiver,".//*[@id='pass-mismatch-id']/h5");
	...
	public WebElement facebookButton() {
		faceBookButton = Locator.getByXPath(dRiver, ".//*[@id='e3createaccont-facebook-button']");
